...
def speak_time(lang = "en", m = "The time will be", delta = 15, cmdline = False):
	...
	while int(message_go) == False:
		...
		if(int(int(message_s) - delta) == 30):
			...
			play("single-short-high", cmdline)
...
if import_safe("pysine", "0.9.2"):
	...
	def pips_beats(type = "gts"):
		...
		elif type.lower() == "uk" or type.lower() == "en" or type.lower() == "nz" or type.lower() == "gts":
	...
	def play(type = "gmt", cmdline = False):
